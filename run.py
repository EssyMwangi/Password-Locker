...
def main():
    ...
    while True:
        ...
        if short_code == "c":
            ...
            while True:
                print(
                    " T - To type your own pasword if you already have an account:\n G - To generate random Password")
                password_Choice = input().lower().strip()
                if password_Choice == 't':
            ...
            save_credentials(create_new_credential(
                account_platform, userName, password))
            print('\n')
            print(
                f"Account Credential for: {account_platform} - UserName: {userName} - Password:{password} created succesfully")
            print('\n')
        elif short_code == "dc":
            if display_account_details():
                ...
                for account_platform in display_account_details():
                    print(
                        f" Account_platform:{account_platform.account_platform} \n User Name:{username}\n Password:{password}")
                    print('_' * 30)
                print('*' * 30)
            else:
            ...
            if find_credentials(account_platform):
                ...
                print(
                    f"Account Platform : {search_credential.account_platform}")
                print('-' * 50)
                print(
            ...
            if find_credentials(account_platform):
                ...
                print('\n')
                print(
                    f"Your stored credentials for : {search_credential.account_platform} successfully deleted!!!")
                print('\n')
            else:
                print(
